...
/*
 <RadioButton fx:id="kg" maxHeight="-Infinity" maxWidth="-Infinity" minHeight="-Infinity" minWidth="-Infinity" mnemonicParsing="false" prefWidth="90.0" text="Kg - lb" />
            <RadioButton fx:id="g" text="g - oz"/>
            <RadioButton fx:id="km" text="Km - mi"/>
            <RadioButton fx:id="km1" text="Km - m"/>
            <RadioButton fx:id="mm" text="mm - in"/>
            <RadioButton fx:id="mm1" text="mm - m"/>
